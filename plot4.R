...
#
par(mar=c(4,4,2,1))
plot(dt$Voltage, type = "l", axes = FALSE, xlab = "datetime", ylab="Voltage")
axis(1,c(0,1460,2880), c("Thu", "Fri", "Sat"))
axis(2,c(234,238,242,246))
#
par(mar=c(3.2,4,2,1))
plot(dt$Sub_metering_1, type = "l", axes = FALSE, ylab = "Energy sub metering")
...
#
par(mar=c(4,4,2,1))
plot(dt$Global_reactive_power, type = "l", axes=F, xlab = "datetime", ylab = "Global_reactive_power")
axis(1,c(0,1460,2880), c("Thu", "Fri", "Sat"))
